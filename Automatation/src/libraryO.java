...
public class libraryO {
	private static String text;
	private static Scanner fileInput = null;
	private static final String source = "C:\\eclipse\\33docNo.txt";
	private static final String source2 = "C:\\eclipse\\test.txt";
	private static final int lineNo = 51;

	
	private static String pairs[][] = new String[lineNo][2];
	...
	private static String[][] getPairs() {
		int i = 0;
		String pairList[][] = new String[lineNo][2];
		String[] pairTemp;
